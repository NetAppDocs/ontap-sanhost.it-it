...
summary: Installare le utilità host Linux su un host RHEL 10 per gestire le operazioni dei protocolli FCP e iSCSI con i LUN ONTAP. 
---
...
È possibile utilizzare multipathing con RHEL 10 per gestire i LUN di ONTAP.
