...
--
La casella di posta in arrivo nativa `qla2xxx` Il driver incluso nel kernel RHEL 8,4 GA ha le correzioni più recenti, essenziali per il supporto di ONTAP.
