...
Con Rocky Linux 10, il  `nvmefc-boot-connections.service` E  `nvmf-autoconnect.service` servizi di avvio inclusi in NVMe/FC  `nvme-cli` i pacchetti vengono abilitati automaticamente all'avvio del sistema. Al termine dell'avvio, verificare che i servizi siano abilitati.
