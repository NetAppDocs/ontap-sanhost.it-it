...
summary: Installare Linux Host Utilities su un host RHEL 9.x per gestire le operazioni del protocollo FCP e iSCSI con LUN ONTAP . 
---
= Configurare RHEL 9.x per FCP e iSCSI con storage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
È possibile utilizzare il multipathing con RHEL 9.x per gestire le LUN ONTAP .
