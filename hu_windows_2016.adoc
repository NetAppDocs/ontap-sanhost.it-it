...
---
= Utilizzare Windows Server 2016 con ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
È possibile utilizzare le impostazioni di configurazione dell'host SAN ONTAP per configurare Windows Server 2016 per il funzionamento con lo storage ONTAP.
