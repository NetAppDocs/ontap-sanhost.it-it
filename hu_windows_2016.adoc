...
summary: Installa Windows Host Utilities su un host Windows Server 2016 per gestire le operazioni del protocollo FCP e iSCSI con LUN ONTAP . 
---
= Configurare Windows Server 2016 per FCP e iSCSI con storage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Le utilità host Windows consentono di connettere gli host Windows ai dischi virtuali (LUN) su una SAN NetApp .  Installare Windows Host Utilities su un host Windows Server 2016 per gestire le operazioni del protocollo FCP e iSCSI con LUN ONTAP .
...
.Fasi
. Scaricare le correzioni rapide da link:https://www.catalog.update.microsoft.com/Search.aspx?q=Update+Windows+Server+2016["Catalogo di aggiornamenti Microsoft 2016"^].
