...
NOTE: Per configurare Oracle Linux 7,1 Red Hat Enterprise kernel (RHCK), utilizzare il link:hu_rhel_71.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 7,1.



== Problemi noti

Non ci sono problemi noti per Oracle Linux 7,1 con ONTAP release.
