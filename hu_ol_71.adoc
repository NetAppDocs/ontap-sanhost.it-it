...
NOTE: Per configurare Oracle Linux 7,1 Red Hat Compatible kernel (RHCK), utilizzare il link:hu_rhel_71.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 7,1.
