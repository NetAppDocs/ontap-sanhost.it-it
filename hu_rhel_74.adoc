...
---
= Utilizza Red Hat Enterprise Linux 7.4 con ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
È possibile utilizzare le impostazioni di configurazione dell'host SAN di ONTAP per configurare Red Hat Enterprise Linux 7,4 con ONTAP come destinazione.
...
La versione RHEL 7,4 con ONTAP presenta i seguenti problemi noti:
