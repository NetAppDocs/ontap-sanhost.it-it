...
summary: Installare Linux Host Utilities su un host RHEL 10 per gestire le operazioni del protocollo FCP e iSCSI con LUN ONTAP . 
---
= Configurare RHEL 10 per FCP e iSCSI con storage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
È possibile utilizzare il multipathing con RHEL 10 per gestire le LUN ONTAP .
