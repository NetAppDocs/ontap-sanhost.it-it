...
---
= Utilizzo di Citrix XenServer con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
Questo documento fornisce indicazioni sulle impostazioni di configurazione degli host SAN ONTAP per le release dei sistemi operativi Citrix XenServer 7 con protocolli FC, FCoE e iSCSI.
...
.Esempio
In questo esempio per Citrix XenServer 7.x, `sda` È il disco SCSI locale da aggiungere alla blacklist.
