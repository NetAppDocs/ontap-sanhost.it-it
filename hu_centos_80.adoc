...
Per i problemi noti di CentOS (Red Hat Compatible kernel), consultare la link:hu_rhel_80.html#known-problems-and-limitations["problemi noti"] per Red Hat Enterprise Linux (RHEL) 8,0.
