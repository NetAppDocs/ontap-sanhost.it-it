...
NOTE: Per i problemi noti di Oracle Linux (Red Hat Compatible kernel), consultare la link:hu_rhel_81.html#known-problems-and-limitations["problemi noti"] per Red Hat Enterprise Linux (RHEL) 8,1.
