...
[NOTE]
====
Devi modificare il valore del parametro LimTransferSize dopo l'installazione di Windows Host Utilities 7.2. Vedi <<parameter-72,Parametri NVME>>.
...
[[parameter-72]]Il programma di installazione di Windows Host Utilities imposta automaticamente i valori del registro di sistema di Windows e i parametri HBA iSCSI e NVMe in base alle scelte che fai durante l'installazione. Controlla questi valori e la versione del sistema operativo.
...
* Il vendor HBA
* Che tu stia utilizzando il software MPIO
