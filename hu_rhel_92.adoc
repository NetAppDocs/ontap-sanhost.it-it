...
---
= Utilizza Red Hat Enterprise Linux 9.2 con ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
È possibile utilizzare le impostazioni di configurazione dell'host SAN di ONTAP per configurare Red Hat Enterprise Linux 9,2 con ONTAP come destinazione.
...
La versione RHEL 9,2 con ONTAP presenta i seguenti problemi noti:
