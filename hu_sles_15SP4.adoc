...
summary: Installare le utilità host Linux su SUSE Linux Enterprise Server 15 SP4 per gestire le operazioni dei protocolli FCP e iSCSI con i LUN ONTAP. 
---
= Configurare SUSE Linux Enterprise Server 15 SP4 per FCP e iSCSI con lo storage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Con SUSE Linux Enterprise Server 15 SP4 è possibile utilizzare il multipathing per gestire i LUN di ONTAP.
