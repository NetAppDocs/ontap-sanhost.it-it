...
---
= Configurare SUSE Linux Enterprise Server 15 SP7 per FCP e iSCSI con lo storage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Con SUSE Linux Enterprise Server 15 SP7 è possibile utilizzare il multipathing per gestire i LUN di ONTAP.
