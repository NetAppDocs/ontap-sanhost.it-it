...
---
= Utilizzo di Oracle Linux 6.5 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NOTE: Per configurare Oracle Linux 6.5 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_65.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 6.5.



== Problemi e limitazioni noti

Non esistono problemi noti per Oracle 6.5.
