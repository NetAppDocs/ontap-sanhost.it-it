...
NOTE: Per configurare Oracle Linux 6,5 Red Hat Compatible kernel (RHCK), utilizzare il link:hu_rhel_65.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 6,5.
...
NOTE: Per i problemi noti di Oracle Linux RHCK, consultare la link:hu_rhel_65.html#known-problems-and-limitations["problemi noti"] per RHEL 6,5.
