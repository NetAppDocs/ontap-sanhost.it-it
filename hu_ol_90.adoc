...
Le sezioni seguenti forniscono un output multipath di esempio per un LUN mappato a figure ASA e non ASA.
...
NOTE: Per configurare Oracle Linux 9,0 Red Hat Enterprise kernel (RHCK), utilizzare il link:hu_rhel_86.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 9,0.
