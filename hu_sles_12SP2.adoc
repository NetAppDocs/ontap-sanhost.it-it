...
Il sistema operativo SUSE Linux Enterprise Server 12 SP2 viene compilato per riconoscere le LUN ONTAP e impostare automaticamente correttamente tutti i parametri di configurazione.
