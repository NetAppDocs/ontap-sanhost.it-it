...
La configurazione dell'host NVMe-OF per Oracle Linux 9.0 con la release ONTAP presenta i seguenti problemi noti:
...
Prima di eseguire la risoluzione dei problemi relativi a NVMe-of, verificare che la configurazione in uso sia conforme alle specifiche IMT, quindi procedere con i passi successivi per eseguire il debug di eventuali problemi relativi all'host.
