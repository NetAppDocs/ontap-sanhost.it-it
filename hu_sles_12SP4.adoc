...
---
= Utilizzo di SUSE Linux Enterprise Server 12 SP4 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
Il sistema operativo SUSE Linux Enterprise Server 12 SP4 viene compilato per riconoscere le LUN ONTAP e impostare automaticamente tutti i parametri di configurazione correttamente.
...
Non esistono problemi noti per SUSE Linux Enterprise Server 12 SP4.
