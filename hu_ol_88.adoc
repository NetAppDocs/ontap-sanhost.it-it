...
NOTE: Per configurare Oracle Linux 8,8 Red Hat Compatible kernel (RHCK), utilizzare il link:hu_rhel_88.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 8,8.
