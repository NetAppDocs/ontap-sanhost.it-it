...
NOTE: Per configurare Oracle Linux 8,8 RedHat Enterprise kernel (RHCK), utilizzare il link:hu_rhel_88.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 8,8.
