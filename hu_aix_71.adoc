...
---
= Utilizzo di IBM AIX 7.1 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
È possibile scaricare il file compresso contenente i pacchetti software host Utilities dal NetApp Support Site. Una volta ottenuto il file, è necessario estrarlo per ottenere i due pacchetti software necessari per installare le Utility host.
