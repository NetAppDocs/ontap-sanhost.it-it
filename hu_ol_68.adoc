...
NOTE: Per configurare Oracle Linux 6,8 Red Hat Enterprise kernel (RHCK), utilizzare il link:hu_rhel_68.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 6,8.
