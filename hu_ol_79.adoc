...
NOTE: Per configurare Oracle Linux 7,9 Red Hat Enterprise kernel (RHCK), utilizzare il link:hu_rhel_79.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 7,9.
