...
summary: Installa Windows Host Utilities su un host Windows Server 2012 R2 per gestire le operazioni del protocollo FCP e iSCSI con LUN ONTAP . 
---
= Configurare Windows Server 2012 R2 per FCP e iSCSI con storage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Le utilità host Windows consentono di connettere gli host Windows ai dischi virtuali (LUN) su una SAN NetApp .  Installare Windows Host Utilities su un host Windows Server 2012 R2 per gestire le operazioni del protocollo FCP e iSCSI con LUN ONTAP .
