...
[role="lead"]
È possibile utilizzare le impostazioni di configurazione dell'host SAN di ONTAP per configurare SUSE Linux Enterprise Server 12 con ONTAP come destinazione.
...
La versione SLES 12 con ONTAP presenta i seguenti problemi noti:
