...
NOTE: Per configurare Oracle Linux 7.4 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_74.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 7.4.
