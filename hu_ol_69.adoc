...
NOTE: Per configurare Oracle Linux 6,9 Red Hat Compatible kernel (RHCK), utilizzare il link:hu_rhel_69.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 6,9.
...
NOTE: Per i problemi noti di Oracle Linux RHCK, consultare la link:hu_rhel_69.html#known-problems-and-limitations["problemi noti"] per RHEL 6,9.
