...
[role="lead"]
È possibile utilizzare le impostazioni di configurazione dell'host SAN di ONTAP per configurare Oracle Linux 6,9 con ONTAP come destinazione.
...
NOTE: Per configurare Oracle Linux 6,9 Red Hat Enterprise kernel (RHCK), utilizzare il link:hu_rhel_69.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 6,9.



== Problemi noti

Oracle Linux 6,9 con ONTAP presenta i seguenti problemi noti:
