...
Per i problemi noti di CentOS (Red Hat Compatible kernel), consultare la link:hu_rhel_68.html#known-problems-and-limitations["problemi noti"] per Red Hat Enterprise Linux (RHEL) 6,8.
