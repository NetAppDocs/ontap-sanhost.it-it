...
---
= Installare Windows Unified host Utilities 7,1
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
|===
Le utilità host supportano diverse configurazioni host di Windows, protocolli e opzioni di multipathing. Vedere https://mysupport.netapp.com/matrix/["Tool di matrice di interoperabilità NetApp"^] per l'elenco aggiornato delle configurazioni supportate.
