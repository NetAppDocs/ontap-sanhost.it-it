...
---
= Utilizzo di Oracle Linux 6.7 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NOTE: Per configurare Oracle Linux 6.7 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_67.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 6.7.



== Problemi e limitazioni noti

Non esistono problemi noti per Oracle 6.7.
