...
summary: Installare le utilità host Linux su un host RHEL 9,5 per gestire le operazioni dei protocolli FCP e iSCSI con i LUN ONTAP. 
---
= Configurare RHEL 9,5 per FCP e iSCSI con storage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
== Fase 2: Verificare la configurazione multipath per l'host

È possibile utilizzare multipathing con RHEL 9,5 per gestire i LUN di ONTAP.
