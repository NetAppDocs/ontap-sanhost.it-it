...
NOTE: Per configurare Oracle Linux 7.7 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_77.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 7.7.
