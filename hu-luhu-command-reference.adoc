...
summary: 'Descrive come utilizzare Linux Host Utilities con l"archiviazione ONTAP' 
---
= Utilizzare i comandi di Linux Host Utilities per verificare la configurazione dell'archiviazione ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
È possibile utilizzare il riferimento ai comandi di esempio di Linux Host Utilities per una convalida end-to-end della configurazione di storage NetApp mediante lo strumento Host Utilities.
