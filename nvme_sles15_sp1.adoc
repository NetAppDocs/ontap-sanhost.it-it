...
Nessuno. Gli script nativi di connessione automatica NVMe/FC sono inclusi nel pacchetto nvme-cli. È possibile utilizzare il driver lpfc inbox nativo su SLES15 SP1.
