...
summary: Installare le Linux Host Utilities su un SUSE Linux Enterprise Server 16 per gestire le operazioni dei protocolli FCP e iSCSI con LUN ONTAP. 
---
= Configurare SUSE Linux Enterprise Server 16 per FCP e iSCSI con storage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
È possibile utilizzare il multipathing con SUSE Linux Enterprise Server 16 per gestire le LUN ONTAP.
