...
NOTE: Per configurare Oracle Linux 7.3 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_73.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 7.3.
