...
summary: Configurare Citrix Hypervisor 8.4 per il multipathing e con parametri e impostazioni specifici per le operazioni del protocollo FCP e iSCSI con storage ONTAP . 
---
...
[role="lead"]
Configurare Citrix Hypervisor 8.4 per il multipathing e con parametri e impostazioni specifici per le operazioni del protocollo FCP e iSCSI con storage ONTAP .
...
È possibile utilizzare il multipathing con Citrix Hypervisor 8.4 per gestire le LUN ONTAP .
