...
summary: Configurare Citrix Xenserver 8.4 per il multipathing e con parametri e impostazioni specifici per le operazioni del protocollo FCP e iSCSI con storage ONTAP . 
---
= Configurare Citrix Xenserver 8.4 per FCP e iSCSI con storage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Configurare Citrix Xenserver 8.4 per il multipathing e con parametri e impostazioni specifici per le operazioni del protocollo FCP e iSCSI con storage ONTAP .

[NOTE]
====
Il pacchetto software Linux Host Utilities non supporta i sistemi operativi Citrix Xenserver.
...
È possibile utilizzare il multipathing con Citrix Xenserver 8.4 per gestire le LUN ONTAP .
