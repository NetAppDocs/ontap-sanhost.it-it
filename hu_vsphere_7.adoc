...
---
= Utilizzo di VMware vSphere 7.x con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
Questo documento fornisce indicazioni sulle impostazioni di configurazione degli host SAN ONTAP per vSphere 7.x con protocolli FC, FCoE e iSCSI.
