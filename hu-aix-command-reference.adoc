...
summary: È possibile utilizzare il riferimento del comando di esempio delle utilità host AIX per una convalida end-to-end della configurazione di archiviazione NetApp utilizzando lo strumento Utilità host. 
---
= Utilizzare i comandi di AIX Host Utilities per verificare la configurazione dell'archiviazione ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
È possibile utilizzare il riferimento del comando di esempio delle utilità host AIX per una convalida end-to-end della configurazione di archiviazione NetApp utilizzando lo strumento Utilità host.
...
.8.0
--
.Mostra esempio per AIX Host Utilities 8.0
[%collapsible]
=====
[listing]
----
...
.7.0 e 6.1
--
.Mostra esempio per AIX Host Utilities 7.0 e 6.1
[%collapsible]
=====
[listing]
----
