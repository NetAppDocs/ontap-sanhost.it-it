...
NOTE: Per configurare Oracle Linux 7.0 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_70.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 7.0.
