...
NOTE: Per configurare Oracle Linux 9,3 Red Hat Enterprise kernel (RHCK), utilizzare il link:hu_rhel_93.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 9,3.
