...
Per i problemi noti del kernel compatibile con CentOS Red Hat, vedere link:hu-rhel-8x.html#known-problems-and-limitations["problemi noti"] per la serie Red Hat Enterprise Linux (RHEL) 8.x.
