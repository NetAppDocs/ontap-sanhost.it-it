...
NOTE: Per configurare Oracle Linux 9,4 Red Hat Enterprise kernel (RHEK), utilizzare il link:hu_rhel_94.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 9,4.
