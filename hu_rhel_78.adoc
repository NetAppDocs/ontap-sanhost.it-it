...
summary: Installare Linux Host Utilities su un host RHEL 7.8 per gestire le operazioni del protocollo FCP e iSCSI con LUN ONTAP. 
---
= Configurare RHEL 7,8 per FCP e iSCSI con storage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
È possibile utilizzare multipathing con RHEL 7,8 per gestire i LUN di ONTAP.
...
Il problema noto di RHEL 7,8 con ONTAP è il seguente:
