...
NOTE: Per configurare Oracle Linux 6,6 Red Hat Compatible kernel (RHCK), utilizzare il link:hu_rhel_66.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 6,6.
...
NOTE: Per i problemi noti di Oracle Linux RHCK, consultare la link:hu_rhel_66.html#known-problems-and-limitations["problemi noti"] per RHEL 6,6.
