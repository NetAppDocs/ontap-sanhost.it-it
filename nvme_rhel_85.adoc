...
La casella di posta in arrivo nativa `qla2xxx` Il driver incluso nel kernel GA RHEL 8.5 dispone delle correzioni upstream più recenti, essenziali per il supporto di ONTAP.
