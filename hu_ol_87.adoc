...
---
= Utilizzo di Oracle Linux 8.7 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1P
:allow-uri-read: 
...
NOTE: Per configurare Oracle Linux 8.7 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_87.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 8.7.
...
Non esistono problemi noti per Oracle Linux 8.7.
