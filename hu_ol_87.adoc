...
NOTE: Per configurare Oracle Linux 8,7 Red Hat Compatible kernel (RHCK), utilizzare il link:hu_rhel_87.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 8,7.
