...
--
Il driver inbox qla2xxx nativo incluso nel kernel OL 9,2 GA ha le ultime correzioni upstream. Queste correzioni sono essenziali per il supporto di ONTAP.
