...
* Non c'è supporto snellun per NVMe/FC e, di conseguenza, nessun supporto per NVMe/FC su Oracle Linux 7,8. Utilizzare l'output del comando ONTAP disponibile come parte del plug-in NetApp incluso nella nvme-cli nativa.
