...
Il sistema operativo SUSE Linux Enterprise Server 15 SP1 viene compilato per riconoscere le LUN ONTAP e impostare automaticamente tutti i parametri di configurazione correttamente.
