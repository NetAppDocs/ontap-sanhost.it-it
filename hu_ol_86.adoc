...
NOTE: Per i problemi noti di Oracle Linux (Red Hat Compatible kernel), consultate la link:hu_rhel_86.html#known-problems-and-limitations["problemi noti"] sezione nella relativa documentazione di rilascio di Red Hat Enterprise Linux.
