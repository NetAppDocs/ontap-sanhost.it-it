...
NOTE: Per configurare Oracle Linux 8.6 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_86.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 8.6.
