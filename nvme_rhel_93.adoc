...
--
.Fasi
. Il driver inbox qla2xxx nativo incluso nel kernel RHEL 9,3 GA ha le ultime correzioni essenziali per il supporto di ONTAP. Verificare che siano in esecuzione le versioni del firmware e del driver dell'adattatore supportate:
+
[listing]
----
