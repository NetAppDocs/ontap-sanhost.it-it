...
Per informazioni dettagliate sul provisioning e la gestione di vVol, fare riferimento alla documentazione relativa ai tool ONTAP per VMware vSphere, nonché https://docs.netapp.com/us-en/netapp-solutions/virtualization/vsphere_ontap_ontap_for_vsphere.html["TR-4597"^] a. link:https://www.netapp.com/pdf.html?item=/media/13555-tr4400pdf.pdf["TR-4400."^]
