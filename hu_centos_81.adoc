...
Per i problemi noti di CentOS (kernel compatibile con Red Hat), consultare link:hu_rhel_81.html#known-problems-and-limitations["problemi noti"] Per Red Hat Enterprise Linux (RHEL) 8.1.
