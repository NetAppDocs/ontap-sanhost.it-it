...
NOTE: Per configurare Oracle Linux 8.5 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_85.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 8.5.
