...
NOTE: Per configurare Oracle Linux 8.2 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_82.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 8.2.
