...
+
** Non ci sono nuove funzionalità in questa versione.
...
Con RHEL 9,6, il  `nvmefc-boot-connections.service` E  `nvmf-autoconnect.service` servizi di avvio inclusi in NVMe/FC  `nvme-cli` I pacchetti vengono abilitati automaticamente all'avvio del sistema.
