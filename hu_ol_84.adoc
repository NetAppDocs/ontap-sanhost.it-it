...
NOTE: Per configurare Oracle Linux 8,4 Red Hat Compatible kernel (RHCK), utilizzare il link:hu_rhel_84.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 8,4.
...
NOTE: Per i problemi noti di Oracle Linux RHCK, consultare la link:hu_rhel_84.html#known-problems-and-limitations["problemi noti"] sezione nella relativa documentazione di rilascio di RHEL.
