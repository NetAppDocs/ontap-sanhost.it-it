...
---
= Utilizza Oracle Linux 8.4 con ONTAP
:hardbreaks:
:toclevels: 1P
:allow-uri-read: 
:toclevels: 1P
...
[role="lead"]
È possibile utilizzare le impostazioni di configurazione dell'host SAN di ONTAP per configurare Oracle Linux 8,4 con ONTAP come destinazione.
...
NOTE: Per configurare Oracle Linux 8,4 Red Hat Enterprise kernel (RHCK), utilizzare il link:hu_rhel_84.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 8,4.
...
Non ci sono problemi noti per Oracle Linux 8,4 con ONTAP release.
