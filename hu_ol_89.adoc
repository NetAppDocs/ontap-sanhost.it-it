...
NOTE: Non devono essere richiesti più di quattro percorsi per una singola LUN. Più di otto percorsi potrebbero causare problemi di percorso durante gli errori dello storage.
...
NOTE: Per configurare Oracle Linux 8,9 RedHat Enterprise kernel, utilizzare il link:hu_rhel_88.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 8,9.
