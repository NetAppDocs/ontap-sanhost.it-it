...
--
.Fasi
. Il driver nativo qla2xxx della posta in arrivo incluso nel kernel GA RHEL 9.2 ha le ultime correzioni upstream essenziali per il supporto di ONTAP. Verificare che siano in esecuzione le versioni del firmware e del driver dell'adattatore supportate:
+
[listing]
----
