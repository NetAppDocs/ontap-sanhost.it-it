...
NOTE: Per configurare Oracle Linux 8.0 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_80.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 8.0.
