...
NOTE: Per configurare Oracle Linux 8,0 Red Hat Compatible kernel (RHCK), utilizzare il link:hu_rhel_80.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 8,0.
...
NOTE: Per i problemi noti di Oracle Linux RHCK, consultare la link:hu_rhel_80.html#known-problems-and-limitations["problemi noti"] per RHEL 8,0.
