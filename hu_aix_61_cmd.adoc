...
---
= Esempio di riferimento del comando di AIX host Utilities 6,1
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
[role="lead"]
È possibile utilizzare il riferimento comandi di esempio AIX host Utilities 6,1 per una convalida end-to-end della configurazione di archiviazione NetApp utilizzando lo strumento utilità host.
