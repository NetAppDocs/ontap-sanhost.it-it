...
* Non esiste un supporto completo per NVMe-of. Pertanto, il supporto dell'utilità host non è disponibile per NVMe-of su un host SUSE Linux Enterprise Server 15 SP5. Puoi utilizzare il plug-in NetApp incluso nel pacchetto nvme-cli nativo per tutti i trasporti NVMe-of.
