...
--
====
. Vai al https://mysupport.netapp.com/site/products/all/details/hostutilities/downloads-tab/download/61343/8.0/downloads["Sito di supporto NetApp"^] e scarica il file compresso contenente le Host Utilities in una directory sul tuo host.
