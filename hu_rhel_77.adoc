...
summary: Installare Linux Host Utilities su un host RHEL 7.7 per gestire le operazioni del protocollo FCP e iSCSI con LUN ONTAP. 
---
= Configurare RHEL 7,7 per FCP e iSCSI con storage ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
È possibile utilizzare multipathing con RHEL 7,7 per gestire i LUN di ONTAP.
...
La versione RHEL 7,7 con storage ONTAP presenta i seguenti problemi noti:
