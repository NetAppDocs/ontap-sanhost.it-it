...
NOTE: Per configurare Oracle Linux 7.2 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_72.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 7.2.
