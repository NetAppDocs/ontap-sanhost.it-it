...
NOTE: Per configurare Oracle Linux 7.8 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_78.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 7.8.
