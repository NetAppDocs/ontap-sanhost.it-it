...
NOTE: Per configurare Oracle Linux 9.1 RedHat Enterprise kernel (RHCK), utilizzare link:hu_rhel_91.html#recommended-settings["impostazioni consigliate"] Per Red Hat Enterprise Linux (RHEL) 9.1.
