...
NOTE: Per configurare Oracle Linux 9,1 Red Hat Compatible kernel (RHCK), utilizzare il link:hu_rhel_91.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 9,1.
