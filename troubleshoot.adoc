...
Prima di iniziare la risoluzione dei problemi, verificare di eseguire una configurazione conforme a https://mysupport.netapp.com/matrix/#welcome["Tool di matrice di interoperabilità"^] specifiche e quindi procedere con i passaggi successivi per risolvere eventuali problemi lato host.


NOTE: Le istruzioni per la risoluzione dei problemi non sono applicabili agli host AIX, ESXi, Proxmox e Windows.
...
Se i problemi persistono, raccogli i seguenti file e output dei comandi e contatta link:https://mysupport.netapp.com["Supporto NetApp"^] per un ulteriore controllo:
