...
summary: Installare Linux Host Utilities su un host Proxmox VE 9.0 per gestire le operazioni del protocollo FCP e iSCSI con LUN ONTAP . 
---
...
* Proxmox VE 9.0 non supporta la configurazione di avvio SAN.
