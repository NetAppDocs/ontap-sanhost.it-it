...
[role="lead"]
È possibile utilizzare le impostazioni di configurazione dell'host SAN di ONTAP per configurare Red Hat Enterprise Linux 9,1 con ONTAP come destinazione.
...
La versione RHEL 9,1 con ONTAP presenta i seguenti problemi noti:
