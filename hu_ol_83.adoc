...
NOTE: Per configurare Oracle Linux 8,3 Red Hat Enterprise kernel (RHCK), utilizzare il link:hu_rhel_83.html#recommended-settings["impostazioni consigliate"] per Red Hat Enterprise Linux (RHEL) 8,3.
...
NOTE: Per i problemi noti di Oracle Linux (Red Hat Compatible kernel), consultate la link:hu_rhel_83.html#known-problems-and-limitations["problemi noti"] sezione nella relativa documentazione di rilascio di Red Hat Enterprise Linux.
