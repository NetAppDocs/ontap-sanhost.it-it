...
---
= Utilizzo di CentOS 7.1 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
Il sistema operativo CentOS 7.1 viene compilato per riconoscere le LUN ONTAP e impostare automaticamente tutti i parametri di configurazione correttamente per la configurazione ASA e non ASA.
...
Non esistono problemi noti per CentOS 7.1.
