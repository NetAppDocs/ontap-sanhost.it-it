...
In RHEL 10.0, la iopolicy predefinita è round-robin, ma queue-depth è disponibile come opzione configurabile. Se usi RHEL 10.0, puoi cambiare la iopolicy in queue-depth modificando il file delle regole udev.
